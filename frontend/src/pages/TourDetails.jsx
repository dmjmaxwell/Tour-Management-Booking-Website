...
const TourDetails = () => {
  ...
  // static data will be called later
            ...
            <div className="tour__content">
              ...
              <div className="tour__info">
                ...
                <div className="tour__extra-details">
                  ...
                  <span><i className="ri-map-pin-user-fill"></i>{distance} k/m</span>
                  <span><i className="ri-group-line"></i> {maxGroupSize} people </span>
                </div>
                <h5>Description</h5>
                <p>{desc}</p>
              </div>
              {/* ________________________tour reviews section___________________________*/}
              <div className="tour__reviews mt-4 ">
                <h4>Reviews ({reviews ?. length} reviews)</h4>
                <Form onSubmit={submitHandler}>
                  <div className='d-flex align-items gap-3 mb-4 rating__group'>
                  ...
                  <div className="review__input">
                    ...
                    <button className="btn primary__btn text-white" type='submit' onSubmit={submitHandler}>Submit</button>
                  </div>
                </Form>
                      ...
                      <div className="review__item">
                        ...
                        <div className="w-100">
                          <div className="d-flex align-items-center justify-content-between">
                            <div>
                              <h5>Muhib</h5>
                              <p>{new Date('23-7-2023').toLocaleDateString("en-US", options)}</p>
                            </div>
                            <span className='d-flex align-items-center d'>
              ...
              {/* ________________________tour reviews section end___________________________*/}
            </div>
          </Col>
          <Col lg="4">
