...
const Booking = ({tour,avgRating }) => {
    ...
    const [credentials, setCredentials] = useState({
        userId: '01',
        userEmail:'ayomidimejiayoola@gmail.com',
        fullName:'',
        phone:'',
        guestSize:1,
        bookAt:'',
  ...
  return <div className='booking'>
    ...
    {/*______________________ booking form__________________________*/}
    ...
    {/*______________________ booking end__________________________*/}
